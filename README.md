...
- feat(dict): 更新丰城与南昌词典词条
- fix(core): 在 Rime 会话间保留组词光标位置
- fix(macos): 改进组词光标与候选窗锚定
- fix(windows): 保留 TSF 组词光标位置
- fix(linux): 支持在组词中间移动光标和编辑
- fix(macos): 强化资源构建与兼容性校验
...
我们项目尽可能使用地道的本字、正字，兼顾民间常用写法，可以引导用户一种规范且兼顾通俗的地方汉语文本。
...
目前，我们已经建成南昌市区、新余市分宜县与丰城市三个词典点位。另希望就别的点位进行充分扩展。欢迎参与我们的词典增添与校正！
...
由于系统特性，碰到系统设置中添加输入法时列表中没有，添加后还无法切换等情况，请尝试注销重登。
...
| gon-pin | 默认IPA | 弋阳IPA | 丰城IPA | 兼容输入 | 说明                                          |
| ------- | ------- | ------- | -------- | -------- | --------------------------------------------- |
| b       | [p]     | -       | -       | —        |                                               |
| p       | [pʰ]    | -       | -       | —        |                                               |
| m       | [m]     | -       | -       | —        |                                               |
...
| k       | [kʰ]    | -       | - | —        |                                               |
| ng      | [ŋ]     | -       | - | —        | 舌根鼻音，例字：五 ng3                        |
| h       | [h]     | -       | [x] | —        | 丰城IPA [x] 对应赣拼 h；[h]发音位置与普通话h不同，更加靠后。 |
...
- IPA 韵尾 `[-ʔ]` 统一标记为赣拼 `[-k]`。
- 入声韵尾可以省略输入，仍可匹配对应读音。
- 各地区独立指定 `-t`、`-p`、`-k` 的任意组合，也可以不设入声；同一地区已启用的入声韵尾之间互相兼容。
...
| ai | [ai] | - | - | — |  |
| oi | [oi] | - | - | — |  |
| ei | [ei]或[ɨi] | - | [ɛi] | — | [ei]仅是合音 |
| au | [au] | - | [ɑu] | ao |  |
| eu | [ɛu]或 [ɨu] | - | [əu] | ou（部分声母后） |  |
| an | [an] | - | - | — |  |
| am | - | - | [am] | — |  |
| en | [ɛn] 或 [ɨn] | - | [ən] | — |  |
| on | [on] | - | - | — |  |
| ang | [ɑŋ] | - | - | — |  |
| ong | [ɔŋ] | - | [oŋ] | on（弋阳） | 弋阳ong不分前后 |
| eng | - | [ən] | - | en（弋阳） | 大部分人已不区分en和eng |
| at | [at] | - | - | — |  |
| ap | - | - | [ap] | — |  |
| ot | [ot] | - | [ɵt] | — |  |
| op | - | - | [ɵp] | — |  |
...
| aep | - | - | [æp] | — |  |
| ok | [ɔʔ] | - | [oʔ]或[ɵʔ] | — |  |
| ek | - | [ɛʔ]或[ɤʔ] | [ɛʔ]或[ɨʔ] | — | [ɤʔ]可以写作ek或uk |
...
| uo | [uo] | - | - | - |  |
| ue | [ue] | - | [uɛ] | - |  |
| ui | [uei] | - | [uɛi]或[ui] | uei、wei（零声母）, wi |  |
| uie | - | - | [uiɛ] | wie（零声母） | |
| uin | - | - | [uin] | - |  |
| uai | [uai] | - | - | - |  |
| uoi | - | [uoi] | - | oi |  |
...
| uok | [uoʔ] | - | [uɔʔ] |  |  |
| uik | - | - | [uɛiʔ] | uek |  |
| uek | — | [uɛʔ]或[uɤʔ]或[uɪʔ] | [uɛʔ]或[uɨʔ] | uik |  |
...
| yun | [yn] | - | - | — |  |
| yuon | [yon] | - | - | yuen, yoin |  |
| yuen | - | [yɛn]或[yɛŋ] | - | yueng |  |
| yung | - | [yn] | [yŋ]或[iuŋ] | yun |  |
| yut | [yt] | - | - | - |  |
| yuk | - | - | [yʔ]或[iuʔ] | - | |
| yuot | [yot] | - | - | yue, yuet |  |
| yuet | - | - | [yet] | yuot |  |
