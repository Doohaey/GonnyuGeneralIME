...
- fix(windows): 修复任务栏与文件搜索中的候选分页、弹窗定位、光标推进及跨输入框组合状态隔离。
- fix(windows): 修复 QQ、终端等窗口切换后首轮直出英文、Shift 失效及非活动输入法 UI 残留。
- style(android): 键盘、操作键、123 符号页与半透明拼音标签统一改为淡蓝色系。

## 目录

- [赣语通用输入法 GonnyuGeneralIME](#赣语通用输入法-gonnyugeneralime)
  - [测试版本 0.2.4-pre.16](#测试版本-024-pre16)
  - [目录](#目录)
  - [简介](#简介)
    - [特色](#特色)
  - [功能演示](#功能演示)
