...
**一键安装/简单易用的赣语输入法，会拼音就能使用，方言拼音与普通话兼容支持。不会说赣语也能用来玩！**
...
目前，我们已经建成南昌市区和新余市分宜县两个词典点位。另希望就别的点位进行充分扩展。词典的发音和标注还存在一批需要纠正之处，还需要广泛听取校正意见。欢迎参与校正。
...
限于词典体量、作者水平和精力，词典内容还有大量问题，都由作者承担。感谢所有提出修改意见的用户。
